...
export default function CrudPlanes() {
  // 🔹 Eliminamos "ID" del header visible
  const headers = ["Nombre", "Descripción Corta", "Descripción Larga", "Precio", "Ciudad", "Ubicación"];
            ...
            planes.map((plan) => (
              <tr key={plan.id} className="hover:bg-gray-50">
                ...
                <td className="py-2 px-4 border-b">
                  {/* 🔹 El id sigue existiendo para las acciones */}
