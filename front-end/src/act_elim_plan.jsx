                ...
                <tbody>
                    {planes.map((plan) => (
                        <tr key={rowIndex} className="hover:bg-gray-50">
                            ...
                            <td className="py-2 px-4 border-b">{new Date(plan.horario).toLocaleString()}</td>
                            <td className="py-2 px-4 border-b">{plan.ubicacion}</td>

                            <td className="py-2 px-4 border-b">
                                <button onClick={() => handleEdit(plan.id)} className="bg-blue-500 text-white px-3 py-1 rounded hover:bg-blue-600">Editar</button>
                            </td>

                            <td className="py-2 px-4 border-b">
                                <button onClick={() => handleEdit(plan.id)} className="bg-blue-500 text-white px-3 py-1 rounded hover:bg-blue-600">Eliminar</button>
                            </td>
                        </tr>
                    ))}
