...
const [password, setPassword] = useState("");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch("http://localhost:8000/administrador/restablecer-contrasena", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ correo, nuevaContrasena: password }),
      });
      ...
      if (res.ok) {
        ...
        localStorage.removeItem("correoRecuperacion"); // limpiar
